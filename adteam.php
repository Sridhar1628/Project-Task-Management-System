                    ...
                    <?php if ($teams_result->num_rows > 0): ?>
                        <?php while ($team = $teams_result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="remove_team.php" style="display:inline;">
                                         <input type="hidden" name="team_id" value="<?= $team['team_id']; ?>">
                                        <button type="submit" name="remove_team" class="remove-button" onclick="return confirm('Are you sure to remove the team?')">Remove</button>
                                    </form>
